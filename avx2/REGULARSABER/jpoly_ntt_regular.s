...
poly_invntt_tomont_1_jazz:
	...
	leaq	512(%rsp), %rax
	leaq	(%rsp), %rcx
	leaq	Lpoly_invntt_tomont_1_jazz$1(%rip), 	%rsi
...
poly_invntt_tomont_0_jazz:
	...
	leaq	512(%rsp), %rax
	leaq	(%rsp), %rcx
	leaq	Lpoly_invntt_tomont_0_jazz$1(%rip), 	%rsi
...
poly_ntt_1_jazz:
	...
	leaq	512(%rsp), %rax
	leaq	(%rsp), %rcx
	leaq	Lpoly_ntt_1_jazz$1(%rip), 	%rdx
	jmp 	Lpoly_ntt_1$1
Lpoly_ntt_1_jazz$1:
	vmovdqu	512(%rsp), %ymm0
	vmovdqu	%ymm0, (%rdi)
...
poly_ntt_0_jazz:
	...
	leaq	512(%rsp), %rax
	leaq	(%rsp), %rcx
	leaq	Lpoly_ntt_0_jazz$1(%rip), 	%rdx
	jmp 	Lpoly_ntt_0$1
Lpoly_ntt_0_jazz$1:
	vmovdqu	512(%rsp), %ymm0
	vmovdqu	%ymm0, (%rdi)
