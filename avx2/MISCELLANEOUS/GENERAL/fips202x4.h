...
void keccak_absorb4x(__m256i *s,
                        ...
                        unsigned char p); // Only in header for unit test purposes; Removed static modifier for unit test purposes
...
void keccak_squeezeblocks4x(unsigned char *h0, 
                               ...
                               __m256i *s, 
                               unsigned int r); // Only in header for unit test purposes; Removed static modifier for unit test purposes
