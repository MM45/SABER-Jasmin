/*** test_fips202x4_regular_KeccakF1600_StatePermute4x_debug.c: File containing the unit test for the KeccakF1600_StatePermutex4 function, with (regular) SABER parameters, for debugging purposes ***/
...
int main() 
{
	...
	// Test
	KeccakF1600_StatePermute4x_debug(s_c);
	KeccakF1600_StatePermute4x_debug_jazz(s_jazz);
