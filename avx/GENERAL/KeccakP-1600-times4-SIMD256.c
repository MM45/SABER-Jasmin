...
#define laneIndex(instanceIndex, lanePosition) ((lanePosition)*4 + instanceIndex)
    ...
    //#define LOAD256u(a)             _mm256_loadu_si256((const V256 *)&(a)) // not used
    //#define LOAD4_64(a, b, c, d)    _mm256_set_epi64x((UINT64)(a), (UINT64)(b), (UINT64)(c), (UINT64)(d)) // not used
...
static const UINT64 rho56[4] = {0x0007060504030201, 0x080F0E0D0C0B0A09, 0x1017161514131211, 0x181F1E1D1C1B1A19};
    ...
    //#define STORE256u(a, b)         _mm256_storeu_si256((V256 *)&(a), b) // not used
    // #define STORE2_128(ah, al, v)   _mm256_storeu2_m128d((V128*)&(ah), (V128*)&(al), v) //not used
