 ...
 struct
  ...
  let var_eqP __top_assumption_ =
    let _evar_0_ = fun t1 n1 __top_assumption_0 ->
      ...
      in
      let { vtype = x; vname = x0 } = __top_assumption_0 in _evar_0_ x x0
    in
    let { vtype = x; vname = x0 } = __top_assumption_ in _evar_0_ x x0
    ...
    let map2Pred _ _ m1 m2 x =
      let _evar_0_ = fun mi1 ->
        ...
        let _evar_0_0 =
          let _evar_0_0 =
            let _evar_0_0 = fun _ _ _ _ x0 -> x0 in
            (fun a -> let { vtype = x0; vname = x1 } = x in _evar_0_0 x0 x1 a)
          in
          let _evar_0_1 =
