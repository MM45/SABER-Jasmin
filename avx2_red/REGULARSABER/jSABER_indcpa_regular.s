...
indcpa_kem_enc_jazz:
	...
	vmovdqu	glob_data + 416(%rip), %ymm2
	movb	18088(%rsp), %al
	movb	%al, 32(%rsp)
	movb	18089(%rsp), %al
	movb	%al, 33(%rsp)
...
Lindcpa_kem_enc_jazz$1:
	...
	vmovdqu	glob_data + 32(%rip), %ymm12
...
indcpa_kem_keypair_randominc_jazz:
	...
	vmovdqu	glob_data + 448(%rip), %ymm0
	vmovdqu	%ymm0, 1792(%rsp)
	vpbroadcastw	glob_data + 688(%rip), %ymm0
	vpbroadcastw	glob_data + 694(%rip), %ymm1
	movq	%rsp, %rax
	movq	%rsp, %rdx
	vmovdqu	glob_data + 448(%rip), %ymm2
	vmovdqu	%ymm2, 64(%rsp)
	vmovdqu	%ymm2, 96(%rsp)
...
LGenSecret$1:
	movq	%rax, 992(%rsp)
	leaq	224(%rsp), %rax
	vmovdqu	glob_data + 448(%rip), %ymm3
	vmovdqu	%ymm3, (%rsp)
	vmovdqu	%ymm3, 32(%rsp)
	vmovdqu	%ymm3, 64(%rsp)
	vmovdqu	%ymm3, 96(%rsp)
...
LGenMatrix$1:
	...
	movq	%rax, 3952(%rsp)
	leaq	208(%rsp), %rax
	vmovdqu	glob_data + 448(%rip), %ymm4
	vmovdqu	%ymm4, (%rsp)
	vmovdqu	%ymm4, 32(%rsp)
	vmovdqu	%ymm4, 64(%rsp)
	vmovdqu	%ymm4, 96(%rsp)
