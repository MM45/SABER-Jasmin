/*** test_fips202x4_regular_keccak_absorb4x_512_64.c: File containing the unit test for the keccak_absorb4x_512_64 function, with (regular) SABER parameters ***/
...
int main() 
{
	...
	// Test
	keccak_absorb4x(s_c, SHA3_512_RATE, m0, m1, m2, m3, 64, 0x06);
	keccak_absorb4x_512_64_jazz(s_jazz, m0, m1, m2, m3);
