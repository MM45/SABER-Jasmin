/*** test_fips202x4_regular_KeccakF1600_StatePermute4x.c: File containing the unit test for the KeccakF1600_StatePermute4x function, with (regular) SABER parameters ***/
